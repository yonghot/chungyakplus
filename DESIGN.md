...
**시각적 아이덴티티**: "복잡한 청약 정보를 명확하고 신뢰감 있게 전달하는 깔끔한 인터페이스"
...
| 애니메이션 | Tailwind animate | 기본 transition만 사용, framer-motion은 MVP 미사용 |
...
| 환경 | 구조 | 비고 |
|------|------|------|
| 모바일 | 하단 탭바 (4~5개 탭) | 아이콘 + 레이블 |
| 데스크톱 | 좌측 사이드바 | 접기/펼치기 가능 |
